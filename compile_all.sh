...
catkin_make --source Simulator/FAST_LIO --build build/FAST_LIO
catkin_make --source Simulator/livox_ros_driver --build build/livox_ros_driver
# 编译控制模块
...
catkin_make --source Modules/ego-planner-swarm --build build/ego-planner-swarm
